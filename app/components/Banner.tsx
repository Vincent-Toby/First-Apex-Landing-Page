...
export default function Banner({}: Props) {
  ...
  return (
    <div className="h-[100dvh] landingpage-container flex items-center w-full">
      ...
      >
        <div className="w-full inset-0 absolute flex flex-col sm:gap-[40px] sm:justify-between md:justify-center gap-[30px] items-start z-10 bg-[#093B3B]/90 h-full px-[24px] md:px-[40px] py-[80px] rounded-2xl">
          <div className="flex flex-col items-center sm:items-start">
            <h4 className="text-white/70 text-center md:text-left text-[14px]">
              Your child deserves to be here.
            </h4>
            <h3 className="text-white font-[700] text-[56px] md:text-[64px] leading-tight sm:leading-none tracking-wide sm:text-[70px] text-center md:text-left dmax-w-[36rem]">
              <span className="text-[28px] md:text-[36px] font-[300]">Welcome To:</span> <br />First Apex Schools
            </h3>
          </div>
